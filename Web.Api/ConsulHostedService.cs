...
namespace Web.Api
{
    public class ConsulHostedService : IHostedService
    {
        ...
        private readonly IOptions<Consul> _consulConfig;
        private readonly ILogger<ConsulHostedService> _logger;
        private readonly IServer _server;
        private string _registrationId;

        public ConsulHostedService(IConsulClient consulClient, IOptions<Consul> consulConfig, ILogger<ConsulHostedService> logger, IServer server)
        {
            _server = server;
            _logger = logger;
